...
class ExtratoPreviewView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        return Response({
            ...
            "saldo_anterior": header.dados_brutos.get("saldo_anterior"),
            "total_debito": header.dados_brutos.get("total_debito"),
            "total_credito": header.dados_brutos.get("total_credito"),
