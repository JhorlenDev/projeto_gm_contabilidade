"""
Tipos base, helpers e parser genérico (fallback).
Todos os parsers específicos importam daqui.
"""
...
class PDFExtratoParser:
    ...
    def _extract_lancamentos(self) -> list[LancamentoExtrato]:
        ...
        for line_idx, line in enumerate(self._lines):
            ...
            # Ignorar linhas de resumo/totalizador (ex: "Total -", "Total Disponível")
            if re.match(r"^Total\b", remaining, re.IGNORECASE):
                continue
